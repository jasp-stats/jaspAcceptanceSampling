...
test_that("BayesianSampling runs without error", {
  ...
  jaspFile <- testthat::test_path("..", "..", "examples", "BaySampl.jasp")
  ...
  set.seed(1)
  results <- jaspTools::runAnalysis("BayesianSampling", encoded$dataset, encoded$options, encodedDataset = TRUE)
